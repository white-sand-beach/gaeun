...
public class GetReviewConsumerResponse {
    ...
    @Builder
    private GetReviewConsumerResponse(Long reviewId, String content, String imageUrl, Long consumerId, String nickname, Long storeId, String storeName, String createdAt) {
