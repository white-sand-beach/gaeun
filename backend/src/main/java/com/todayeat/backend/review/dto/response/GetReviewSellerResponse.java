...
@Getter
@Schema(name = "GetReviewSellerResponse", description = "판매자 리뷰 조회 응답")
public class GetReviewSellerResponse {
    ...
    public static GetReviewSellerResponse from (Review review) {
