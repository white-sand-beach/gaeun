...
public class GetSaleToConsumerResponse {
    ...
    @Builder
    private GetSaleToConsumerResponse(Long saleId, String imageUrl, String name, Integer originalPrice, Integer sellPrice, Integer discountRate, String content, Integer restStock) {
        this.saleId = saleId;
