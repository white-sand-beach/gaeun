...
export const ServiceBanner = () => {
  return (
    <div className="center">
      ...
      <div className="ml-1 font-bold text-amber-950">
...
export const ServiceBanner1 = () => {
  return (
    <div className="center">
      ...
      <div className="ml-3 font-bold text-amber-950">
        <p className="text-xs">음식을 나누는 행복한 세상</p>
        <h1 className="text-xl">함께 만들어가요</h1>
      </div>
    </div>
  );
};
...
export const ServiceBanner2 = () => {
  return (
    <div className="center">
      ...
      <div className="ml-3 font-bold text-amber-950">
        <p className="text-xs">가운데에서 나눔을 베풀다</p>
        <p className="text-xl">우리모두, 가은</p>
      </div>
    </div>
  );
};
...
export const ServiceBanner3 = () => {
  return (
    <div className="center">
      ...
      <div className="ml-3 font-bold text-amber-950">
        <p className="text-xs">오늘부터 시작 하는</p>
        <h1 className="text-xl">음식문화 만들기</h1>
      </div>
    </div>
  );
};
...
export const ServiceBanner4 = () => {
  return (
    <div className="center">
      ...
      <div className="ml-3 font-bold text-amber-950">
        <p className="text-xs">음식을 나눔하는</p>
        <h1 className="text-lg">천사가게 살펴볼까요?</h1>
      </div>
    </div>
  );
};
