const OrderDetail = () => {
  return (
    <div className="yes-footer items-start px-4 gap-2">
      <h1>음식명(메뉴이름)</h1>
      ...
      <div className="flex flex-col w-full font-bold border-2 p-2 rounded-[10px] mt-5">
        <p className="border-b-2 p-2">주문 내역</p>
      ...
      <div className="flex flex-col w-full font-bold border-2 border-black p-2 rounded-[10px] mt-5">
        <p className="border-b-2 p-2">결제 내역</p>
        <div className="flex flex-col justify-center border-b-2">
          <div className="flex flex-row justify-between text-gray-500 p-2">
            <p>주문금액</p>
            <p>13,900원</p>
          </div>
          <div className="flex flex-row justify-between text-gray-500 p-2">
