    ...
    return (
        <div className="flex flex-col gap-3">
            {props.salesLists.map((list) => (
                <div key={list.saleId} className="flex flex-row gap-4 border-4 border-orange-500 rounded-lg">
                    <img src={list.imageUrl ? list.imageUrl : 임시사진} alt="메뉴 사진" className="w-[60px] h-[60px]"/>
